...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
		...
		<div class="right">
			<div class="tabs">
				<ul>
					<li class="cattab selected">Categories</li><li class="acctab">Account Info</li>
				</ul>
			</div>
	        <div class="quiz" style="display:block">
				<div class="category">
		        	...
		        	<div class="next" style="overflow:hidden"><a class="next catnext" href="#">Submit</a><img src="img/whiteblue.gif" class="wheel" /></div>
				</div>
				
				<div class="accountinfo" style="display:none">
		        	<h2>Set your account information.</h2>
					<ul>
						<li><label for="acc_name">Name:</label><input id="acc_name" type="text"></li>
						<li><label for="acc_email">Email:</label><input id="acc_email" type="text"></li>
					</ul>
		        	<div class="next" style="overflow:hidden"><a class="next accnext" href="#">Submit</a><img src="img/whiteblue.gif" class="wheel" /></div>
				</div>
	        </div>
			...
			<div class="avatar" style="display:none">
				<div class="frame">
					...
					<form id="cropform" action="account.php" method="post" onsubmit="return checkCoords();">
			        	...
			        	<div class="next"  style="margin-top:20px; overflow:hidden"><a class="next" href="#" onclick="document.getElementById('cropform').submit()">Submit Avatar</a></div>
					</form>
				</div>
			</div>
			...
			$(document).ready(function(){
				...
				$("a.catnext").on("click", function (e){
					...
					$.ajax({
						...
						$(".wheel").toggle();
						if (msg == "added cats") alert("Update Successes!");
					});
					console.log(query);
				});
